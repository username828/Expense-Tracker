...
import { FaBars, FaFacebook, FaTwitter, FaInstagram, FaGithub } from "react-icons/fa"; // Font Awesome icons
...
const Home = () => {
  ...
  >
    <h3 className="text-xl font-semibold text-center mb-4">Add Expense</h3>
    <img src='/expense1.jpg' className="w-full h-48 object-cover rounded-lg mb-4"/>
  ...
  >
    ...
    <img src='/expense2.jpg' className="w-full h-48 object-cover rounded-lg mb-4"/>
    <p className="text-center">View a detailed breakdown of your expenses</p>
  </div>
  ...
  >
    ...
    <img src='/budget.jpeg' className="w-full h-48 object-cover rounded-lg mb-4"/>
    <p className="text-center">Set and track your budget goals</p>
      ...
      <footer className="bg-green-700 text-white py-4 mt-auto">
        ...
        <p className="text-center">&copy; 2024 Expense Tracker. All rights reserved.</p>
      </footer>
    </div>
  );
};
